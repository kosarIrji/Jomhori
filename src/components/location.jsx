      ...
      {windowHeight < 500 ? (
        ...
        >
          ...
          <p className="md:leading-loose lg:leading-loose font-modam  text-justify text-base  ">
            محله‌ی جمهوری در بخش غربی بافت مرکزی شهر قرار گرفته، که از طریق
            خیابان امام خمینی، بلوار مدرس و خیابان قیام با سایر محلات شهر پیوند
            و ارتباط مناسبی ایجاد کرده است؛ این محله با توجه به موقعیت مکانی
            ایده آلی که دارد درحین نزدیکی به بازار و مرکز شهر، در بافت درونی
            محله از آرامش محیطی مناسبی نیز برخوردار است.
          </p>
        </motion.div>
      ) : (
        ""
